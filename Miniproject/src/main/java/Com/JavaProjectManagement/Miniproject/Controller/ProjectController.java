...
import Com.JavaProjectManagement.Miniproject.service.ProjectService;
...
@RequestBody ProjectDTO projectDTO) {
        log.info("Create project endpoint called");
    ...
    public ResponseEntity<List<ProjectDTO>> getAllProjects() {
        log.info("Get all projects endpoint called");
    ...
    public ResponseEntity<ProjectDTO> getProjectById(@PathVariable("id") Long id) {
        log.info("Get project endpoint called with ID: {}", id);
    ...
    public ResponseEntity<ProjectDTO> updateProject(@PathVariable("id") Long id,
                                                     @Valid
@RequestBody ProjectDTO projectDTO) {
        log.info("Update project endpoint called with ID: {}", id);
...
projectDTO);
    ...
    public ResponseEntity<Void> deleteProject(@PathVariable ("id") Long id) {
        log.info("Delete project endpoint called with ID: {}", id);
